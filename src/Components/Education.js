        ...
        <section id="education" className="education-section">
            ...
            <ul className="education-list cards-stack">
                <li className="education-item">
                    ...
                    <p className="education-description"><a href="https://opintopolku.fi/koski/opinnot/d2976690f206473694982d72cd141b1f" target="_blank" className="academic-transcript-link" rel="noopener noreferrer">Academic Transcript</a></p>
                </li>
                <li className="education-item">
